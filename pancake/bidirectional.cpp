...
*/
{
   ...
   status_index = find_or_insert(&root_state, best, 0, 1, &states, parameters, info, &hash_table, hash_value);
   ...
   hash_value = root_state.hash_value;
   status_index = find_or_insert(&root_state, best, 0, 2, &states, parameters, info, &hash_table, hash_value);
